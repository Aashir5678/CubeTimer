...
class CubeTimer:
    ...
    def stop_timer(self):
        ...
        # Multiphase more than 1
            ...
            self.parent.after(300, change_bg)
    ...
    def open_settings(self):
        ...
        if self.get_settings(cursor):
            ...
            with conn:
                ...
                cursor.execute("INSERT INTO settings VALUES (:inspection, :display_time, :scramble_len, :multiphase)",
        ...
        ClearSolvesButton.place(x=260, y=215)
        CopyTimesButton.place(x=260, y=160)
        ShowKeyBindsButton.place(x=240, y=186)
